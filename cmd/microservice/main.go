...
import (
	...
	"gitea-cicd.apps.aws2-dev.ocp.14west.io/cicd/golang-html-transform/pkg/handlers"
	"gitea-cicd.apps.aws2-dev.ocp.14west.io/cicd/golang-html-transform/pkg/validator"
...
func startHttpServer(con connectors.Clients) *http.Server {
	...
	r.HandleFunc("/api/v1/transform", func(w http.ResponseWriter, req *http.Request) {
		handlers.TransformHandler(w, req, con)
	}).Methods("POST")
